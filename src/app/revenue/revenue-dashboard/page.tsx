...
import { Info, Save, ArrowUpRight, Download } from "lucide-react"
import { cn } from "@/lib/utils"

const glassCard =
  "rounded-3xl border border-border/50 bg-card/40 backdrop-blur-sm p-6 shadow-lg"
      ...
      <div className="relative space-y-6">
        ...
        <div className={cn(glassCard, "bg-card dark:bg-gradient-to-r dark:from-[#1a1f35]/80 dark:to-[#101426]/80")}>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <div className="space-y-2">
              <label className="text-xs font-medium uppercase tracking-wider text-foreground/60">Sale Cycle</label>
              <Select value={saleCycle} onValueChange={setSaleCycle}>
                <SelectTrigger className="border-border bg-secondary text-foreground focus:ring-offset-0">
            ...
            <div className="space-y-2">
              <label className="text-xs font-medium uppercase tracking-wider text-foreground/60">Focus Sales Cycle</label>
        ...
        <div className="grid gap-6 xl:grid-cols-12">
          ...
          <div className={cn(glassCard, "xl:col-span-8 overflow-hidden")}>
            <div className="mb-6 flex items-center justify-between">
              <div>
                <p className="text-sm uppercase tracking-[0.3em] text-foreground/60">Performance Data</p>
                <h3 className="text-xl font-semibold">Segmentation Analysis</h3>
              </div>
              <Button variant="ghost" size="sm" className="text-xs uppercase tracking-widest text-foreground/60 hover:text-foreground">
                ...
                <tbody className="divide-y divide-white/5 text-foreground">
                  {tableData.map((row, idx) => (
                    <tr key={idx} className="hover:bg-secondary transition-colors">
                      ...
                      <td className="px-6 py-4 text-right text-foreground/60">{row.compRoomsSold}</td>
                      <td className="px-6 py-4 text-right text-foreground/60">${row.compPrice}</td>
                      <td className="px-6 py-4">
                        <span className="inline-flex items-center rounded-full border border-border bg-secondary px-2.5 py-0.5 text-xs font-medium text-foreground/80">
                          {row.champion}
                        </span>
                      </td>
                    </tr>
          ...
          <div className="space-y-6 xl:col-span-4">
            {/* Rooms Sold Card */}
            <div className={cn(glassCard, "bg-card dark:bg-gradient-to-br dark:from-[#131E34] dark:to-[#0B1220]")}>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="rounded-xl bg-secondary p-3">
                  <p className="text-xs text-foreground/50 uppercase">Mix %</p>
            ...
            {/* Price Card */}
            <div className={cn(glassCard, "bg-card dark:bg-gradient-to-br dark:from-[#27144A] dark:to-[#120B1F]")}>
              <div className="flex items-center justify-between mb-4">
              ...
              <div className="rounded-xl bg-secondary p-4">
                <div className="flex justify-between items-end">
                  <div>
                    <p className="text-xs text-foreground/50 uppercase">YoY Change</p>
            ...
            <div className={cn(glassCard, "bg-card dark:bg-gradient-to-br dark:from-[#101934] dark:to-[#080C1E]")}>
              ...
              <div className="space-y-4">
                 <div className="flex justify-between items-center pb-3 border-b border-border">
                    <span className="text-sm text-foreground/60">Mix of Revenue</span>
                    <span className="font-semibold">68%</span>
                 </div>
                 <div className="flex justify-between items-center pb-3 border-b border-border">
                    <span className="text-sm text-foreground/60">Cost of Acq.</span>
                    <span className="font-semibold">$12,450</span>
                 </div>
                 <div className="flex justify-between items-center">
                    <span className="text-sm text-foreground/60">Gross Margin</span>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className={cn(glassCard)}>
            <div className="mb-4">
               <p className="text-sm uppercase tracking-[0.3em] text-foreground/60">Analysis</p>
